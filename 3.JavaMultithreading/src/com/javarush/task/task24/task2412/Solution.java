...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            ...
            {
            	String value1 = (String)stock1.get("name");
            	String value2 = (String)stock2.get("name");
            	...
            	if (result == 0)
				{
					...
					if (result == 0)
					{
						...
						double benefit2 = last2 - open2;
						
						if (benefit1 > benefit2)
							result = -1;
						else if (benefit2 > benefit1)
							result = 1;
					}
				}
